...
public class Geofence implements OnClickListener {
        ...
        public void onMapClick(LatLng arg0) {
            ...
            switch (fenceType) {
                ...
                case 1:
                    ...
                    overlays.add(MainActivity.mBaiduMap.addOverlay(overlayOptions));
    ...
    private void createVertexesFence() {
        ...
        MainActivity.client.createVertexesFence(MainActivity.serviceId, creator, fenceName, fenceDesc,
                monitoredPersons, observers,
    ...
    private void updateVertexesFence() {
        ...
        // 报警条件（1：进入时触发提醒，2：离开时触发提醒，3：进入离开均触发提醒）
        int alarmCondition = 3;
        MainActivity.client.updateVertexesFence(MainActivity.serviceId, fenceName, fenceId, fenceDesc,
                monitoredPersons, observers,
                validTimes, validCycle, validDate, validDays, coordType,
    ...
    private void initOnGeoFenceListener() {
        ...
        geoFenceListener = new OnGeoFenceListener() {
            ...
            public void onRequestFailedCallback(String arg0) {
                ...
                Toast.makeText(MainActivity.mContext, "geoFence请求失败回调接口消息 : " + arg0, Toast.LENGTH_LONG).show();
    ...
    protected static void addMarker() {
        try {
            ...
            // 圆形围栏覆盖物
            if (null != circleFenceOverlaysOption) {
                circleFenceOverlay = MainActivity.mBaiduMap.addOverlay(circleFenceOverlaysOption);
            }

            // 多边形围栏覆盖物
            if (null != vertexesFenceOverlayOption) {
                vertexesFenceOverlay = MainActivity.mBaiduMap.addOverlay(vertexesFenceOverlayOption);
            }
        } catch (Exception e) {
